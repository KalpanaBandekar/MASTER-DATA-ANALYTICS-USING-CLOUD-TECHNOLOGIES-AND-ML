...
ALTER WAREHOUSE IF EXISTS DEMO_WAREHOUSE SET AUTO_SUSPEND = 600;
...
GRANT USAGE ON TABLE {table_name} TO ROLE {ROLE_NAME};
...
grant USAGE ON TABLE {table_name} on user <anandcoforge123>
show grants on user <anandcoforge123>;
